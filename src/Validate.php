 ...
 * @method static Validate cntrl(string $additionalChars = '')
 * @method static Validate contains(mixed $containsValue, bool $identical = false)
 * @method static Validate confirm(mixed $compareTo, bool $identical = true)
 ...
 * @method static Validate ip(string $range = null, int $options = null)
